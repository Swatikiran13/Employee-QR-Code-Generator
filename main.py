...
class Qr_Generate:
    def __init__(self,root):
        ...
        self.root.title("QR GENERATOR | Developed By Swati KIran")
        ...
        txt_emp_code=Entry(emp_Frame, font=("times new roman",15,'bold'),textvariable=self.var_emp_code,bg='lightblue').place(x=200,y=60)
        txt_name=Entry(emp_Frame , font=("times new roman",15,'bold'),textvariable=self.var_emp_name,bg='lightblue').place(x=200,y=100)
        txt_department=Entry(emp_Frame , font=("times new roman",15,'bold'),textvariable=self.var_emp_department,bg='lightblue').place(x=200,y=140)
        txt_designation=Entry(emp_Frame, font=("times new roman",15,'bold'),textvariable=self.var_emp_designation,bg='lightblue').place(x=200,y=180)
